...
# useless_row = 10 # Count from bottom to top, start from 0 , useless_row = 10
# useless_col = -1 # Count from left to right, start from 0 , useless_col = -1
# remove_last_how_many_value = -8 # Remove the last 10 values from the heatmap data, remove_last_how_many_value = -8
